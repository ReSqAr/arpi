...
def activate( view, exit, globalconfig ):
    ...
    showlistmodel.setup( view,
                            ...
                            lambda index: activate_newspaper( view, activate_here, globalconfig, selected_newspaper[index]), # activation action
                            lambda index: globalconfig.say(selected_newspaper[index]["name"]), # selection action: read name
                            exit
                        )
...
def activate_newspaper( view, back, globalconfig, newspaper ):
    ...
    showlistmodel.setup( view,
                            ...
                            lambda index: activate_article( view, activate_here, globalconfig, articles[index]), # activation action
